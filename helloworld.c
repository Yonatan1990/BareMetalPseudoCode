...
int main( void )
{
	...
	//u16 DataWordsBuffer1 [32];

	u16 data;

	xil_printf( "Hello from Freertos example main\n\r" );
//some testing
	//Xil_Out16(XPAR_AXI_BRAM_CTRL_0_S_AXI_BASEADDR+addr*2,0x1111);

	//data = Xil_In16(XPAR_AXI_BRAM_CTRL_0_S_AXI_BASEADDR+addr*2);
